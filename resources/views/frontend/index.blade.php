    ...
    <div class="py-5 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4>New Arrivals
                        <a href="{{ url('new-arrivals') }}" class="btn btn-warning float-end text-white">View More</a>
                    </h4>
                    <div class="underline"></div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>Featured Products
                        <a href="{{ url('featured-products') }}" class="btn btn-warning float-end text-white">View More</a>
                    </h4>
                    <div class="underline"></div>
                </div>
